...
只返回合法 JSON，不要 Markdown 或解释：{"summary":"简短总结","goal":"不超过80字的可验证完成目标","priority":"high|medium|low","estimatedHours":2.5,"type":"学习类","domainMap":{"prerequisites":[],"coreConcepts":[],"advancedTopics":[]},"resources":{"systemResources":[],"externalRecommendations":{"websites":[],"upMasters":[],"communities":[]}},"coreQuestions":["问题"],"steps":[{"title":"不超过24字的具体动作","hours":0.5,"description":"如何执行","completionCriteria":"可验证的完成标准","questions":["本步骤核心问题"]}]}。
