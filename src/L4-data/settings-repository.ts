export type AppSettingsV1 = {
  ...
  interaction: { animations: boolean; reducedMotion: boolean; buttonFloat: boolean; buttonGlow: boolean; confirmComplete: boolean; confirmDelete: boolean; autoFocus: boolean; editTrigger: "double-click" | "long-press" };
...
export const DEFAULT_SETTINGS: AppSettingsV1 = {
  ...
  interaction: { animations: true, reducedMotion: false, buttonFloat: true, buttonGlow: true, confirmComplete: false, confirmDelete: true, autoFocus: true, editTrigger: "double-click" },
